...
void Vtb_counter___024root___timing_commit(Vtb_counter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_counter___024root___timing_commit\n"); );
    Vtb_counter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void Vtb_counter___024root___trigger_orInto__act(VlUnpacked<QData/*63:0*/, 1> &out, const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_counter___024root___trigger_orInto__act\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
bool Vtb_counter___024root___eval_phase__act(Vtb_counter___024root* vlSelf) {
    ...
    Vtb_counter___024root___timing_commit(vlSelf);
    Vtb_counter___024root___trigger_orInto__act(vlSelfRef.__VnbaTriggered, vlSelfRef.__VactTriggered);
...
void Vtb_counter___024root___eval(Vtb_counter___024root* vlSelf) {
    ...
    do {
        ...
        } while (Vtb_counter___024root___eval_phase__act(vlSelf));
    } while (Vtb_counter___024root___eval_phase__nba(vlSelf));
}
